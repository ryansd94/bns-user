...
const UserProfile = (props) => {
    ...
    function renderUserProfilePopover() {
        return (<UserProfilePopover onBack={handlePopoverClose}  {...props}></UserProfilePopover>)
    }
    return (
        <div onClick={onAvatarClick} onMouseLeave={handlePopoverClose}>
            <LinkControl
                title={user?.email}
            />
            <PopoverControl genderBody={renderUserProfilePopover} onClose={handlePopoverClose} anchorEl={openPopover}></PopoverControl>
        </div>)
}
