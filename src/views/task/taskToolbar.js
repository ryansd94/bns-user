...
import { setColumnVisibility } from "stores/views/task"
...
const TaskToolbar = (props) => {
  ...
  const handleColumnConfigChange = (event) => {
    ...
    let columnModel = _.first(
      _.filter(columnModels, (item) => {
