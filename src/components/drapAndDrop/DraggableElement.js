    ...
    if (item.type === EControlType.typography) {
      ...
      component = (
        <AccordionControl
          ...
          name={item.name}
          className="task-group-container"
          details={<TaskChild name={item.id} control={control} />}
        />
      );
      ...
      component = (
        <AccordionControl
          ...
          name={item.name}
          className="task-group-container"
          details={<TaskParent name={item.id} control={control} />}
        />
      );
      ...
      component = (
        <AccordionControl
          ...
          className="task-group-container"
          details={
            <MultipleFileUploadField name={item.name} control={control} />
          }
        />
      );
    } else if (item.type === EControlType.comment) {
      component = (
        <Comment label={item.label} name={item.id} control={control} />
      );
    }
            ...
            {controls &&
              controls.map((item, index) => {
                if (item.type != EControlType.group) {
                  ...
                  return (
                    <Droppable key={item.id} droppableId={`${item.prefix}`}>
                      {(providedChild) => (
                        <div
                          className={droppableClassName}
