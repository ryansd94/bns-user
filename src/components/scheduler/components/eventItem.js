...
import TaskTypeMenuItem from "views/task/taskTypeMenuItem"
...
class EventItem extends Component {
  ...
  render() {
    ...
    const taskType = <TaskTypeMenuItem {...eventItem.taskType} isDisplayName={false} />
    ...
    let eventItemTemplate = (
      ...
      >
        ...
        >
          <TaskItem isShowTooltip={false} className='event-item' item={eventItem} />
        </span>
