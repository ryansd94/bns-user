...
const ButtonIcon = (props) => {
  ...
  const {
    ...
    isCheckPermissionDefault = false,
    isHoverColor,
  } = props;
  const [titleDefault, setTitle] = useState("");
  const [isCheckPermission, setIsCheckPermission] = useState(
    isCheckPermissionDefault,
  );
  ...
  if (type == "Edit") icon = <IconEdit style={styleIcon} />;
  else if (type == "Delete") icon = <IconDelete style={styleIcon} />;
  else if (type == "Email") icon = <IconEmail style={styleIcon} />;
  else if (type == "Lock") icon = <IconBlock style={styleIcon} />;
  else if (type == "UnLock") icon = <IconUnBlock style={styleIcon} />;
  ...
  else if (type == EButtonIconType.back) icon = <IconBack style={styleIcon} />;
  else if (type == EButtonIconType.more) icon = <IconMore style={styleIcon} />;
  else if (type == EButtonIconType.add) icon = <IconAdd style={styleIcon} />;
  else if (type == EButtonIconType.up) icon = <IconUp style={styleIcon} />;
  else if (type == EButtonIconType.down) icon = <IconDown style={styleIcon} />;
  ...
  else if (type == EButtonIconType.hide) icon = <IconHide style={styleIcon} />;
