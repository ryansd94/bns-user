...
const IconDelete = ({ style, size, onClick, className = "" }) => {
  return (
    <i
      style={style}
      onClick={onClick}
      className={`far fa-trash-alt fa-sm ${className}`}
    ></i>
  );
};
...
const IconExpand = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-angle-down fa-sm ${className}`}
    ></i>
  );
};
const IconRemove = ({ style, className }) => {
  return (
    <i style={style} className={`fa-regular fa-xmark fa-sm ${className}`}></i>
  );
};
...
const IconDescription = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-file-invoice ${className}`}
    ></i>
  );
};
const IconTable = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-table ${className}`}
    ></i>
  );
};
const IconList = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-list ${className}`}
    ></i>
  );
};
const IconRequire = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-exclamation-circle ${className}`}
    ></i>
  );
};
const IconSetting = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-cog ${className}`}
    ></i>
  );
};
const IconSwitchLeft = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-arrow-alt-left ${className}`}
    ></i>
  );
};
const IconSwitchRight = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-arrow-alt-right ${className}`}
    ></i>
  );
};
const IconClose = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-times ${className}`}
    ></i>
  );
};
const IconBell = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`fas fa-bell ${className}`}
    ></i>
  );
};
const IconPlus = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-plus-square ${className}`}
    ></i>
  );
};
const IconMinus = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-minus-square ${className}`}
    ></i>
  );
};
const IconLeft = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-chevron-left ${className}`}
    ></i>
  );
};
const IconRight = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-chevron-right ${className}`}
    ></i>
  );
};
const IconInfo = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-info-circle ${className}`}
    ></i>
  );
};
const IconRefresh = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-sync ${className}`}
    ></i>
  );
};
const IconCollapse = ({ style, className, onClick }) => {
  return (
    <i
      onClick={onClick}
      style={style}
      className={`far fa-angle-right ${className}`}
    ></i>
  );
};
  ...
  return (
    <a className="icon">
      <i
        onClick={onClick}
        style={style}
        className={`far fa-times-circle ${className}`}
      ></i>
    </a>
  );
};
  ...
  return (
    <a className="icon">
      <i
        onClick={onClick}
        style={style}
        className={`far fa-eye-slash ${className}`}
      ></i>
    </a>
  );
};
  ...
  return (
    <a className="icon">
      <i
        onClick={onClick}
        style={style}
        className={`far fa-eye ${className}`}
      ></i>
    </a>
  );
};
