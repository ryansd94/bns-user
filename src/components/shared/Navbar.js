                        ...
                        <Dropdown alignRight>
                            <Dropdown.Toggle className="nav-link count-indicator">
                                ...
                                <div className="nav-language-text">
                                    <p className="mb-1 text-black"><Trans>{language}</Trans></p>
                                </div>
                            </Dropdown.Toggle>
                            <Dropdown.Menu className="preview-list navbar-dropdown">
                                <Dropdown.Item className="dropdown-item d-flex align-items-center" onClick={() => changeLanguage('vi')}>
                                    <div className="nav-language-icon mr-2">
                                        <i className="flag-icon flag-icon-vn" title="vn" id="vn"></i>
                                    </div>
                                    <div className="nav-language-text">
                                        <p className="mb-1 text-black"><Trans>Vietnamese</Trans></p>
                                    </div>
                                </Dropdown.Item>
                                <div className="dropdown-divider"></div>
                                <Dropdown.Item className="dropdown-item d-flex align-items-center" onClick={() => changeLanguage('en')}>
                                    <div className="nav-language-icon mr-2">
